...
export const customers = pgTable("customers", {
  ...
  primary_contact_phone: varchar("primary_contact_phone", { length: 50 }),
  primary_contact_email: varchar("primary_contact_email", { length: 255 }),
  accounts_contact_name: varchar("accounts_contact_name", { length: 255 }),
  accounts_contact_phone: varchar("accounts_contact_phone", { length: 50 }),
  accounts_contact_email: varchar("accounts_contact_email", { length: 255 }),
  account_manager: varchar("account_manager", { length: 255 }),
  credit_limit: decimal("credit_limit", { precision: 10, scale: 2 }).default("50000.00"),
